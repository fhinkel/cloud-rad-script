...
npx repo exec --concurrency=1 -- "git commit -am 'chore(nodejs): update ref docs link in metadata'"
...
npx repo exec --concurrency=1 -- "/usr/local/bin/hub pull-request -r sofisl -m 'chore(nodejs): update ref docs link in metadata'"
npx repo tag --title 'chore(nodejs): update ref docs link in metadata' automerge
# npx repo exec --concurrency=1 -- "git co master"
